                ...
                <div className="card-body p-3 p-md-4 p-xl-5">
                    ...
                    <div className="row gy-3 overflow-hidden">
                        ...
                        <div className="form-floating mb-3">
                            <input type="email" className="form-control" name="email" id="email" placeholder="name@example.com" onChange={(e)=>{
                        ...
                        <div className="col-12">
                        <div className="form-floating mb-3">
                            <input type="password" className="form-control" name="password" id="password"  placeholder="Password" onChange={(e)=>{
                        ...
                        <div className="d-grid">
                            <Link to='/home' className="btn bsb-btn-xl btn-primary" type="submit" onClick={handleSubmit}>Log in now</Link>
                        </div>
                        </div>
                    </div>
                    </form>
